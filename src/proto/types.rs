...
impl ::protobuf::Message for Sample {
    ...
    fn default_instance() -> &'static Sample {
        ...
        unsafe { instance.get(Sample::new) }
    }
}
...
impl ::protobuf::Message for TimeSeries {
            ...
            descriptor.get(|| {
                ...
                fields.push(
                    ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                        _,
                        ::protobuf::types::ProtobufTypeMessage<Label>,
                    >(
                        "labels",
                ...
                fields.push(
                    ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                        _,
                        ::protobuf::types::ProtobufTypeMessage<Sample>,
                    >(
                        "samples",
    ...
    fn default_instance() -> &'static TimeSeries {
        ...
        unsafe { instance.get(TimeSeries::new) }
    }
}
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                >(
                    "name", |m: &Label| &m.name, |m: &mut Label| &mut m.name
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeString,
...
impl ::protobuf::Message for Labels {
    ...
    fn default_instance() -> &'static Labels {
        ...
        unsafe { instance.get(Labels::new) }
    }
}
...
impl ::protobuf::Message for LabelMatcher {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeEnum<LabelMatcher_Type>,
                >(
                    "type",
    ...
    fn default_instance() -> &'static LabelMatcher {
        ...
        unsafe { instance.get(LabelMatcher::new) }
    }
}
...
impl ::protobuf::Message for ReadHints {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.end_ms != 0 {
            my_size +=
                ::protobuf::rt::value_size(4, self.end_ms, ::protobuf::wire_format::WireTypeVarint);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn default_instance() -> &'static ReadHints {
        ...
        unsafe { instance.get(ReadHints::new) }
    }
}
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeEnum<Chunk_Encoding>,
                >(
                    "type",
                ...
                >(
                    "data", |m: &Chunk| &m.data, |m: &mut Chunk| &mut m.data
                ));
...
impl ::protobuf::ProtobufEnum for Chunk_Encoding {
    ...
    fn values() -> &'static [Self] {
        static values: &'static [Chunk_Encoding] = &[Chunk_Encoding::UNKNOWN, Chunk_Encoding::XOR];
        values
    }
...
impl ::protobuf::Message for ChunkedSeries {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(
                    ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                        _,
                        ::protobuf::types::ProtobufTypeMessage<Chunk>,
                    >(
                        "chunks",
    ...
    fn default_instance() -> &'static ChunkedSeries {
        ...
        unsafe { instance.get(ChunkedSeries::new) }
    }
}
